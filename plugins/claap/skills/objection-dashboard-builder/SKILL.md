---
name: objection-dashboard-builder
description: Turn scattered objection data into an interactive monthly dashboard — verbatim quotes, category trends, and coaching insights, branded to your design system.
---

# Objection Dashboard Builder

Runs on your Claap call recordings via the bundled **Claap** MCP server (authorize access on first use). Also uses the **Lovable** MCP server(s) — connect these separately.
